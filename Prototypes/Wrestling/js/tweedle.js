...
// In a browser, use self.performance.now if it is available.
	...
	tweedle_js.NOW = self.performance.now.bind(self.performance);
...
class Group {constructor() { Group.prototype.__init.call(this);Group.prototype.__init2.call(this);Group.prototype.__init3.call(this);Group.prototype.__init4.call(this); }
 ...
 = {};}
	 ...
	 */
	 ...
	 __init4() {this.now = tweedle_js.NOW;} // used to calculate deltatime in case you stop providing one
...
tweedle_js.DEFAULTS = DEFAULTS;

tweedle_js.Easing = Easing;

tweedle_js.Group = Group;

tweedle_js.Interpolation = Interpolation;

tweedle_js.Tween = Tween;

tweedle_js.VERSION = VERSION;
